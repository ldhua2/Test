        ...
        <form id="empAddForm" method="post">
            <table class="grid">
                <tr>
                    ...
                    <td>职务</td>
                    <td><input name="job" type="text"  class="easyui-validatebox" value=""></td>
                </tr>
                <tr>
                    <td>性别</td>
                    <td>
                    ...
                    <td>身高(cm)</td>
                    <td><input name="height" type="text"  class="easyui-validatebox" value=""></td>
                </tr>
                <tr>
                    <td>年龄</td>
                ...
                <tr>
                	<td>班级</td>
                	<td><input type="text" name="dept" class="easyui-validatebox" data-options="required:true"/></td>
                   <!--  <td>班级</td>
                    ...
                    <!-- <td>角色</td>
                    <td><select id="empAddRoleIds" name="roleIds" style="width: 140px; height: 29px;"></select></td> -->
                    <td>用户状态</td>
                    <td>
                ...
                <tr>
	                <td>用户类型</td>
                    <td>
                     <select name="empType" class="easyui-combobox" data-options="width:140,height:29,editable:false,panelHeight:'auto'">
